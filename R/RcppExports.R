...
#' @export
vecchia_grouped_meanzero_loglik_grad_info <- function(covparms, covfun_name, y, locs, NNlist) {
  .Call('_GpGp_vecchia_grouped_meanzero_loglik_grad_info', PACKAGE = 'GpGp', covparms, covfun_name, y, locs, NNlist)
}
...
#' #    covparms, "matern_isotropic", y, locs, array )
#' @export
vecchia_meanzero_loglik_grad_info <- function(covparms, covfun_name, y, locs, NNarray) {
  .Call('_GpGp_vecchia_meanzero_loglik_grad_info', PACKAGE = 'GpGp', covparms, covfun_name, y, locs, NNarray)
}
